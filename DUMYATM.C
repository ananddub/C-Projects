...
void main()
	{
	char user[100][50]={{"admin"},{"Sanjay_sir"},{"Denis_Richi"},{"Mark_zuckerberg"},{"Steve_jobs"},{"Elon_Musk"},{"Mukes_ambani"},{"Anand_Dubey"},{"Piyush_sing"},{"Shiv"},{"Abhishek"},{"Anurag"},{"Sonu"},{"Pankaj"},{"Vipin"},{"Aman"},{"Shreyansh"},{"Bhaivab"},{"Abhinav"},{"Mithu"},{"Ankur"}};
	char pass[100][25]={{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"},{"1234"}},scrkey[]="sanjay_sir";
	...
	int cmpresult,i,j,adminc,len,cr=21,count=0,st=0,st2=0;
	long dumy=0,sum=0;
	textcolor(WHITE);
	fflush(stdout);
	clrscr();
